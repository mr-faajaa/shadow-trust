...
export class ReputationService {
  ...
  private attestations: Map<string, ReputationAttestation[]>;
   ...
   */
  async createAttestation(request: CreateAttestationRequest): Promise<ReputationAttestation> {
   ...
   */
  async getReputation(agentId: string): Promise<ReputationResponse | null> {
   ...
   */
  async verifyAttestation(source: string, sourceId: string): Promise<boolean> {
